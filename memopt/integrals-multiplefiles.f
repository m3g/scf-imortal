...
c Adicionado para escrever as integrais em arquivo:
     ...
     !I4,J4,K4,LX1,LY1,LZ1,LX2,LY2,LZ2,LX3,LY3,LZ3,LX4,LY4,LZ4)
      ...
      indtot = maxd*maxd*maxd*(l-1) + maxd*maxd*(k-1) + maxd*(j-1) + i

      index = int(mod(indtot,lfile)) + 1
      ifile = int((indtot - index) / lfile)
      call chari(ifile,char)
      intfile = './intvalues/intvalues.'//char
      
      open(20,file=intfile,access="direct",
